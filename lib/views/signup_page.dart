    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          SizedBox(height: 186),
          Text('Sign Up',
              style: mediumStyle.copyWith(fontSize: 36, color: primaryColor)),
          SizedBox(height: 20),
          //* Textfield
          FieldText(
              labelText: "Email",
          ...
          FieldText(
              ...
              isSeePasword: Padding(
                  ...
                  child: GestureDetector(
                    onTap: () => setState(() => isSeePasword = !isSeePasword),
          ...
          Row(
              ...
              children: [
                ...
                Text('Keep me logged in',
                    style: regularStyle.copyWith(fontSize: 12, color: grey400)),
              ]),
          SizedBox(height: 10),
          //* Tombol Login
          Tombol(
            childContent:
                Text('Sign Up', style: mediumStyle.copyWith(color: whiteColor)),
            onPressed: () {},
          ...
          Center(
            child: Column(children: [
              ...
              Row(children: [
                Spacer(),
                IconTombol(assetImage: "assets/google.png", pressed: () {}),
                SizedBox(width: 14),
                IconTombol(assetImage: "assets/apple.png", pressed: () {}),
                SizedBox(width: 14),
                IconTombol(assetImage: "assets/facebook.png", pressed: () {}),
                Spacer(),
              ])
            ]),
          ),
